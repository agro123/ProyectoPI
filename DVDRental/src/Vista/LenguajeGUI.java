...
import Controlador.ControladorLenguaje;
 ...
 * @author crist
 */
public class LenguajeGUI extends javax.swing.JFrame {

    /**
     * Creates new form LenguajeGUI
     */
    public LenguajeGUI() {
        initComponents();
        cargarLenguaje();
...
private void limpiarListadoTabla(){
    ...
    public void cargarLenguaje(){
        ...
        listadoLenguaje=ControladorLenguaje.listadoLenguaje(0);
        limpiarListadoTabla();
        for(int i= 0; i < listadoLenguaje.size(); i++){
              modelo.addRow(new Object[]{
              listadoLenguaje.get(i).getLenguajeid(),
              listadoLenguaje.get(i).getName(),
              listadoLenguaje.get(i).getLasUpdate(),
              });
        }
    }
    
        public int calcularId(){
     ArrayList<Lenguaje>all = new ArrayList();
     ControladorLenguaje s = new ControladorLenguaje();
     return s.listadoLenguaje(0).size()+1;
 }
    /**
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        JOptionPane.showMessageDialog(this,"Ingrese el ID");
            ...
            if (jTextField2.getText().trim().equals("")){
                JOptionPane.showMessageDialog(this,"Agregue  nombre al idioma");

            }
            else {
                Lenguaje lenguaje = new Lenguaje();
                lenguaje.setLenguajeid(Integer.parseInt(jTextField1.getText()));
                lenguaje.setName(jTextField2.getText());

                Date date = new Date();
                lenguaje.setLasUpdate(new Timestamp(date.getTime()));

                int tamaño;
                tamaño = ControladorLenguaje.listadoLenguaje(lenguaje.getLenguajeid()).size();

                if(tamaño == 0){
                    int resultado = 0;
                    resultado = ControladorLenguaje.grabarLenguaje(lenguaje);
                    if(resultado == 1){
                        JOptionPane.showMessageDialog(this,
                            "Idioma Grabado con éxito",
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        if(jTextField1.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(this,
                "Por favor seleccione un idioma","Error",
                JOptionPane.ERROR_MESSAGE);
        }
        else{
            int respuesta = JOptionPane.showConfirmDialog(this,
                "¿Desea Eliminar el idioma de id: " +
            ...
            if(respuesta == JOptionPane.YES_OPTION){
                ...
                if(ControladorLenguaje.borrarLenguaje(id) == 1){
                    JOptionPane.showMessageDialog(this,
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if(btnModificar.getText().equalsIgnoreCase("Modificar")){
            ...
            if(ControladorLenguaje.modificarLenguaje(lenguaje) == 1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LenguajeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LenguajeGUI().setVisible(true);
            }
        });
    }
