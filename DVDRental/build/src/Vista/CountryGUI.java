...
private void limpiarListadoTabla(){
    ...
    public void cargarCountry(){
        DefaultTableModel modelo;
        modelo = (DefaultTableModel) jtListado.getModel();    
        ArrayList<Country> listadoCountry = new ArrayList();
        listadoCountry=ControladorCountry.listadoCountry(0);
        limpiarListadoTabla();
        for(int i= 0; i < listadoCountry.size(); i++){
              modelo.addRow(new Object[]{
              listadoCountry.get(i).getCountryid(),
              listadoCountry.get(i).getName(),
              listadoCountry.get(i).getLasUpdate(),
              });
        }
    }
    /**
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        JOptionPane.showMessageDialog(this,"Ingrese el ID");
            ...
            if (jTextField2.getText().trim().equals("")){
                ...
                country.setCountryid(Integer.parseInt(jTextField1.getText()));
                country.setName(jTextField2.getText());

                Date date = new Date();
                country.setLasUpdate(new Timestamp(date.getTime()));

                int tamaño;
                tamaño = ControladorLenguaje.listadoLenguaje(country.getCountryid()).size();
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        if(jTextField1.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(this,
                "Por favor seleccione un país","Error",
                JOptionPane.ERROR_MESSAGE);
        }
        else{
            int respuesta = JOptionPane.showConfirmDialog(this,
                "¿Desea Eliminar el país de id: " +
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if(btnModificar.getText().equalsIgnoreCase("Modificar")){
            ...
            if(ControladorCountry.modificarCountry(country) == 1){
